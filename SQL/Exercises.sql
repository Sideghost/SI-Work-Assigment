...
$$
	begin 
		delete from Registos_Invalidos where (DATEDIFF('day', NOW()::timestamp, marca_temporal) >= 15);
	end;
$$;
	
--select from Registos_Invalidos where (DATE_PART('day', '2014-07- 06:14:00.742000000'::timestamp - marca_temporal::timestamp)>=15);
