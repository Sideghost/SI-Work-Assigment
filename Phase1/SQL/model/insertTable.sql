-- Client values
insert into Cliente
values (123456780, 'joca', 'casa do joca', 123456780, 'P', null),
...
update Cliente
set referencia = 123456780
where nif = '123456781';
update Cliente
set referencia = 123456780
where nif = '123456782';

insert into Institucionais
values (123456783, '12345678'),
       (123456782, '12345678'),
       (123456781, '12345678'),
       (123456784, '12345678'),
...
-- Vehicle values
insert into Veiculo
values ('12345A', 'agnaldo', 123456789, 123456780, 0),
